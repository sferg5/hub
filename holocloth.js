...
void main() {
	...
	`}class uv extends Pn{constructor(t=1,i={}){super(t,t,i),this.isWebGLCubeRenderTarget=!0;const s={width:t,height:t,depth:1},l=[s,s,s,s,s,s];this.texture=new tv(l),this._setTextureOptions(i),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(t,i){this.texture.type=i.type,this.texture.colorSpace=i.colorSpace,this.texture.generateMipmaps=i.generateMipmaps,this.texture.minFilter=i.minFilter,this.texture.magFilter=i.magFilter;const s={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},l=new eo(5,5,5),c=new Cn({name:"CubemapFromEquirect",uniforms:jr(s.uniforms),vertexShader:s.vertexShader,fragmentShader:s.fragmentShader,side:Xn,blending:Fi});c.uniforms.tEquirect.value=i;const f=new vn(l,c),p=i.minFilter;return i.minFilter===Gs&&(i.minFilter=Rn),new uy(1,10,this).update(t,f),i.minFilter=p,f.geometry.dispose(),f.material.dispose(),this}clear(t,i=!0,s=!0,l=!0){const c=t.getRenderTarget();for(let f=0;f<6;f++)t.setRenderTarget(this,f),t.clear(i,s,l);t.setRenderTarget(c)}}function ub(r){let t=new WeakMap,i=new WeakMap,s=null;function l(g,y=!1){return g==null?null:y?f(g):c(g)}function c(g){if(g&&g.isTexture){const y=g.mapping;if(y===Nh||y===Ph)if(t.has(g)){const E=t.get(g).texture;return p(E,g.mapping)}else{const E=g.image;if(E&&E.height>0){const w=new uv(E.height);return w.fromEquirectangularTexture(r,g),t.set(g,w),g.addEventListener("dispose",d),p(w.texture,g.mapping)}else return null}}return g}function f(g){if(g&&g.isTexture){const y=g.mapping,E=y===Nh||y===Ph,w=y===ks||y===Kr;if(E||w){let S=i.get(g);const M=S!==void 0?S.texture.pmremVersion:0;if(g.isRenderTargetTexture&&g.pmremVersion!==M)return s===null&&(s=new a0(r)),S=E?s.fromEquirectangular(g,S):s.fromCubemap(g,S),S.texture.pmremVersion=g.pmremVersion,i.set(g,S),S.texture;if(S!==void 0)return S.texture;{const F=g.image;return E&&F&&F.height>0||w&&F&&m(F)?(s===null&&(s=new a0(r)),S=E?s.fromEquirectangular(g):s.fromCubemap(g),S.texture.pmremVersion=g.pmremVersion,i.set(g,S),g.addEventListener("dispose",_),S.texture):null}}}return g}function p(g,y){return y===Nh?g.mapping=ks:y===Ph&&(g.mapping=Kr),g}function m(g){let y=0;const E=6;for(let w=0;w<E;w++)g[w]!==void 0&&y++;return y===E}function d(g){const y=g.target;y.removeEventListener("dispose",d);const E=t.get(y);E!==void 0&&(t.delete(y),E.dispose())}function _(g){const y=g.target;y.removeEventListener("dispose",_);const E=i.get(y);E!==void 0&&(i.delete(y),E.dispose())}function v(){t=new WeakMap,i=new WeakMap,s!==null&&(s.dispose(),s=null)}return{get:l,dispose:v}}function fb(r){const t={};function i(s){if(t[s]!==void 0)return t[s];const l=r.getExtension(s);return t[s]=l,l}return{has:function(s){return i(s)!==null},init:function(){i("EXT_color_buffer_float"),i("WEBGL_clip_cull_distance"),i("OES_texture_float_linear"),i("EXT_color_buffer_half_float"),i("WEBGL_multisampled_render_to_texture"),i("WEBGL_render_shared_exponent")},get:function(s){const l=i(s);return l===null&&Wr("WebGLRenderer: "+s+" extension not supported."),l}}}function hb(r,t,i,s){const l={},c=new WeakMap;function f(v){const g=v.target;g.index!==null&&t.remove(g.index);for(const E in g.attributes)t.remove(g.attributes[E]);g.removeEventListener("dispose",f),delete l[g.id];const y=c.get(g);y&&(t.remove(y),c.delete(g)),s.releaseStatesOfGeometry(g),g.isInstancedBufferGeometry===!0&&delete g._maxInstanceCount,i.memory.geometries--}function p(v,g){return l[g.id]===!0||(g.addEventListener("dispose",f),l[g.id]=!0,i.memory.geometries++),g}function m(v){const g=v.attributes;for(const y in g)t.update(g[y],r.ARRAY_BUFFER)}function d(v){const g=[],y=v.index,E=v.attributes.position;let w=0;if(E===void 0)return;if(y!==null){const F=y.array;w=y.version;for(let B=0,C=F.length;B<C;B+=3){const P=F[B+0],L=F[B+1],O=F[B+2];g.push(P,L,L,O,O,P)}}else{const F=E.array;w=E.version;for(let B=0,C=F.length/3-1;B<C;B+=3){const P=B+0,L=B+1,O=B+2;g.push(P,L,L,O,O,P)}}const S=new(E.count>=65535?J1:j1)(g,1);S.version=w;const M=c.get(v);M&&t.remove(M),c.set(v,S)}function _(v){const g=c.get(v);if(g){const y=v.index;y!==null&&g.version<y.version&&d(v)}else d(v);return c.get(v)}return{get:p,update:m,getWireframeAttribute:_}}function db(r,t,i){let s;function l(v){s=v}let c,f;function p(v){c=v.type,f=v.bytesPerElement}function m(v,g){r.drawElements(s,g,c,v*f),i.update(g,s,1)}function d(v,g,y){y!==0&&(r.drawElementsInstanced(s,g,c,v*f,y),i.update(g,s,y))}function _(v,g,y){if(y===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(s,g,0,c,v,0,y);let w=0;for(let S=0;S<y;S++)w+=g[S];i.update(w,s,1)}this.setMode=l,this.setIndex=p,this.render=m,this.renderInstances=d,this.renderMultiDraw=_}function pb(r){const t={geometries:0,textures:0},i={frame:0,calls:0,triangles:0,points:0,lines:0};function s(c,f,p){switch(i.calls++,f){case r.TRIANGLES:i.triangles+=p*(c/3);break;case r.LINES:i.lines+=p*(c/2);break;case r.LINE_STRIP:i.lines+=p*(c-1);break;case r.LINE_LOOP:i.lines+=p*c;break;case r.POINTS:i.points+=p*c;break;default:Ee("WebGLInfo: Unknown draw mode:",f);break}}function l(){i.calls=0,i.triangles=0,i.points=0,i.lines=0}return{memory:t,render:i,programs:null,autoReset:!0,reset:l,update:s}}function mb(r,t,i){const s=new WeakMap,l=new tn;function c(f,p,m){const d=f.morphTargetInfluences,_=p.morphAttributes.position||p.morphAttributes.normal||p.morphAttributes.color,v=_!==void 0?_.length:0;let g=s.get(p);if(g===void 0||g.count!==v){let Y=function(){T.dispose(),s.delete(p),p.removeEventListener("dispose",Y)};var y=Y;g!==void 0&&g.texture.dispose();const E=p.morphAttributes.position!==void 0,w=p.morphAttributes.normal!==void 0,S=p.morphAttributes.color!==void 0,M=p.morphAttributes.position||[],F=p.morphAttributes.normal||[],B=p.morphAttributes.color||[];let C=0;E===!0&&(C=1),w===!0&&(C=2),S===!0&&(C=3);let P=p.attributes.position.count*C,L=1;P>t.maxTextureSize&&(L=Math.ceil(P/t.maxTextureSize),P=t.maxTextureSize);const O=new Float32Array(P*L*4*v),T=new Z1(O,P,L,v);T.type=Oi,T.needsUpdate=!0;const N=C*4;for(let G=0;G<v;G++){const Q=M[G],ht=F[G],_t=B[G],J=P*L*4*G;for(let I=0;I<Q.count;I++){const H=I*N;E===!0&&(l.fromBufferAttribute(Q,I),O[J+H+0]=l.x,O[J+H+1]=l.y,O[J+H+2]=l.z,O[J+H+3]=0),w===!0&&(l.fromBufferAttribute(ht,I),O[J+H+4]=l.x,O[J+H+5]=l.y,O[J+H+6]=l.z,O[J+H+7]=0),S===!0&&(l.fromBufferAttribute(_t,I),O[J+H+8]=l.x,O[J+H+9]=l.y,O[J+H+10]=l.z,O[J+H+11]=_t.itemSize===4?l.w:1)}}g={count:v,texture:T,size:new qt(P,L)},s.set(p,g),p.addEventListener("dispose",Y)}if(f.isInstancedMesh===!0&&f.morphTexture!==null)m.getUniforms().setValue(r,"morphTexture",f.morphTexture,i);else{let E=0;for(let S=0;S<d.length;S++)E+=d[S];const w=p.morphTargetsRelative?1:1-E;m.getUniforms().setValue(r,"morphTargetBaseInfluence",w),m.getUniforms().setValue(r,"morphTargetInfluences",d)}m.getUniforms().setValue(r,"morphTargetsTexture",g.texture,i),m.getUniforms().setValue(r,"morphTargetsTextureSize",g.size)}return{update:c}}function gb(r,t,i,s,l){let c=new WeakMap;function f(d){const _=l.render.frame,v=d.geometry,g=t.get(d,v);if(c.get(g)!==_&&(t.update(g),c.set(g,_)),d.isInstancedMesh&&(d.hasEventListener("dispose",m)===!1&&d.addEventListener("dispose",m),c.get(d)!==_&&(i.update(d.instanceMatrix,r.ARRAY_BUFFER),d.instanceColor!==null&&i.update(d.instanceColor,r.ARRAY_BUFFER),c.set(d,_))),d.isSkinnedMesh){const y=d.skeleton;c.get(y)!==_&&(y.update(),c.set(y,_))}return g}function p(){c=new WeakMap}function m(d){const _=d.target;_.removeEventListener("dispose",m),s.releaseStatesOfObject(_),i.remove(_.instanceMatrix),_.instanceColor!==null&&i.remove(_.instanceColor)}return{update:f,dispose:p}}const _b={[h0]:"LINEAR_TONE_MAPPING",[d0]:"REINHARD_TONE_MAPPING",[p0]:"CINEON_TONE_MAPPING",[gu]:"ACES_FILMIC_TONE_MAPPING",[Zr]:"AGX_TONE_MAPPING",[_u]:"NEUTRAL_TONE_MAPPING",[m0]:"CUSTOM_TONE_MAPPING"};function vb(r,t,i,s,l,c){const f=new Pn(t,i,{type:r,depthBuffer:l,stencilBuffer:c,samples:s?4:0,depthTexture:l?new Qr(t,i):void 0}),p=new Pn(t,i,{type:Wn,depthBuffer:!1,stencilBuffer:!1}),m=new ta;m.setAttribute("position",new Bi([-1,3,0,-1,-1,0,3,-1,0],3)),m.setAttribute("uv",new Bi([0,2,0,0,2,0],2));const d=new iv({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
`)+`
`+M);const B=F+S+f,C=F+M+p,P=x1(l,l.VERTEX_SHADER,B),L=x1(l,l.FRAGMENT_SHADER,C);l.attachShader(w,P),l.attachShader(w,L),i.index0AttributeName!==void 0?l.bindAttribLocation(w,0,i.index0AttributeName):i.hasPositionAttribute===!0&&l.bindAttribLocation(w,0,"position"),l.linkProgram(w);function O(G){if(r.debug.checkShaderErrors){const Q=l.getProgramInfoLog(w)||"",ht=l.getShaderInfoLog(P)||"",_t=l.getShaderInfoLog(L)||"",J=Q.trim(),I=ht.trim(),H=_t.trim();let $=!0,mt=!0;if(l.getProgramParameter(w,l.LINK_STATUS)===!1)if($=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(l,w,P,L);else{const bt=M1(l,P,"vertex"),U=M1(l,L,"fragment");Ee("WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(w,l.VALIDATE_STATUS)+`
	...
	vCavity = aCavity;`),l.fragmentShader=`
      ...
      `+l.fragmentShader.replace("#include <emissivemap_fragment>",`#include <emissivemap_fragment>
        ...
        }`).replace("#include <aomap_fragment>",`#include <aomap_fragment>
        {
          ...
          #endif
        }`)},{material:i,uniforms:s}}const Gr=2048;class YT{canvas;texture;decals=[];clothImage=null;selected=null;ctx;constructor(){this.canvas=document.createElement("canvas"),this.canvas.width=Gr,this.canvas.height=Gr,this.ctx=this.canvas.getContext("2d"),this.texture=new pu(this.canvas),this.texture.colorSpace=ti,this.redraw()}setAspect(t){const i=t>=1?Gr:Math.round(Gr*t),s=t>=1?Math.round(Gr/t):Gr;return this.canvas.width===i&&this.canvas.height===s?(this.redraw(),!1):(this.canvas.width=i,this.canvas.height=s,this.texture.dispose(),this.texture=new pu(this.canvas),this.texture.colorSpace=ti,this.redraw(),!0)}addDecal(t){const i={img:t,u:.5,v:.5,scale:.35,rotation:0};return this.decals.push(i),this.selected=i,this.redraw(),i}setClothImage(t){this.clothImage=t,this.redraw()}clear(){this.decals=[],this.clothImage=null,this.selected=null,this.redraw()}hitTest(t,i){const s=this.canvas.width,l=this.canvas.height,c=t*s,f=(1-i)*l;for(let p=this.decals.length-1;p>=0;p--){const m=this.decals[p],{w:d,h:_}=this.decalPixelSize(m),v=m.u*s,g=(1-m.v)*l,y=-m.rotation*Math.PI/180,E=c-v,w=f-g,S=E*Math.cos(y)-w*Math.sin(y),M=E*Math.sin(y)+w*Math.cos(y);if(Math.abs(S)<=d/2&&Math.abs(M)<=_/2)return m}return null}decalPixelSize(t){const i=this.canvas.width,s=t.img.naturalWidth||t.img.width||300,l=t.img.naturalHeight||t.img.height||300,c=t.scale*i,f=c*l/s;return{w:c,h:f}}redraw(){const{ctx:t,canvas:i}=this;t.clearRect(0,0,i.width,i.height),this.clothImage&&t.drawImage(this.clothImage,0,0,i.width,i.height);for(const s of this.decals){const{w:l,h:c}=this.decalPixelSize(s);t.save(),t.translate(s.u*i.width,(1-s.v)*i.height),t.rotate(s.rotation*Math.PI/180),t.drawImage(s.img,-l/2,-c/2,l,c),t.restore()}this.texture.needsUpdate=!0}dispose(){this.texture.dispose()}}const P1=`
  #include <common>
  #include <packing>
  varying vec2 vUv;
